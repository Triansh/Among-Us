 ...
 *  `CMake/Info.plist.in` in the src tree.
 *
 ...
 *
 *  When a window loses input focus, it will create synthetic key release
 ...
 *
 *  Sometimes GLFW needs to create synthetic key events, in which case the
 ...
 *
 *  When a window loses input focus, it will create synthetic mouse button
 ...
 *  but will not create an error.  This can be used instead of first calling
 ...
 *  this function will return `GLFW_FALSE` but will not create an error.  Call
 ...
 *  this function will return `NULL` but will not create an error.  Call
 ...
 *  a window without a context will create a @ref GLFW_NO_WINDOW_CONTEXT
 *  error.
 *
